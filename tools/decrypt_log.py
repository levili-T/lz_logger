...
FOOTER_SIZE = 32  # 盐16字节 + 魔数4字节 + padding4字节 + 文件大小4字节 + 已用大小4字节
...
def read_log_file(file_path: str):
    """
    读取日志文件
    文件格式: [数据区域][盐16字节][魔数4字节][padding4字节][文件大小4字节][已用大小4字节]
    ...
    with open(file_path, 'rb') as f:
        ...
        # 读取 footer: [盐16字节][魔数4字节][padding4字节][文件大小4字节][已用大小4字节]
        ...
        footer_file_size, used_size = struct.unpack('<II', footer[CRYPTO_SALT_SIZE+8:])
