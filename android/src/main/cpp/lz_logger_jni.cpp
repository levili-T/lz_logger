...
Java_com_example_lz_1logger_LzLogger_nativeOpen(
        JNIEnv* env,
        jobject /* this */,
        jstring jLogDir,
        jstring jEncryptKey,
...
Java_com_example_lz_1logger_LzLogger_nativeLog(
        JNIEnv* env,
        jobject /* this */,
        jlong jHandle,
        jint level,
 ...
 */
JNIEXPORT void JNICALL
Java_com_example_lz_1logger_LzLogger_nativeFlush(
        JNIEnv* /* env */,
        jobject /* this */,
        jlong jHandle) {
 ...
 */
JNIEXPORT void JNICALL
Java_com_example_lz_1logger_LzLogger_nativeClose(
        JNIEnv* /* env */,
        jobject /* this */,
        jlong jHandle) {
...
Java_com_example_lz_1logger_LzLogger_nativeExportCurrentLog(
        JNIEnv* env,
        jobject /* this */,
        jlong jHandle) {
...
Java_com_example_lz_1logger_LzLogger_nativeCleanupExpiredLogs(
        JNIEnv* env,
        jobject /* this */,
        jstring jLogDir,
        jint days) {
